...
const UpsellPage = (props) => {
  return (
    <div className='upsell-page-container'>
      {/*  TOP-HEADER  */}
        ...
        <div className='upsell-top-header'>
          ...
          <div className='upsell-header-pannel'>
            <div className='upsell-header-left'>
              <h1>WAIT!</h1>
              <h3>Before You Go...!</h3>
              <p>Add this Natural Pack Kit <br/>to Your Order *</p>
            </div>
      ...
      <div className='upsell-body-section'>
        <div className='upsell-text'>
          ...
          <h3>* You Will NEVER See This Again</h3>
          <span>AT JUST $99</span>
          <p>Lorem ipsum dolor amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.</p>
