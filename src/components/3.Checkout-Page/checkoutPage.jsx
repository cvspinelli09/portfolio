          ...
          <div className="checkout-upper-container">
            ...
            <div className="checkout-upper-right-side">
              ...
              <p>
                ...
                pulvinar dapibus leo luctus nec.
              </p>
            </div>
          </div>
              ...
              <div className="checkout-row">
                <div className="col-50">
                  ...
                  <div className="coupon-container">
                    ...
                    />
                    <button type="button" name="button" placeholder="Apply">
                      Apply
                    </button>
                  </div>
                  <hr />
                      ...
                      <div className="checkout-icon-container">
                        <div>
                          <i
                            ...
                            style={{ color: "#42A5F5", background: "#fff" }}
                          ></i>
                        </div>
                        <div>
                          <i
                  ...
                  <button type="button" name="button" placeholder="Place-order">
                    Place order
                  </button>
